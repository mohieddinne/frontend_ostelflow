    ...
    >
      <div className="flex flex-col flex-grow-0 items-center text-white p-16 text-center md:p-128 md:items-start md:flex-shrink-0 md:flex-1 md:text-left">
        ...
        <FuseAnimate delay={400}>
          ...
          >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean quis ligula quis quam sollicitudin malesuada vestibulum quis lorem. Phasellus a dolor finibus, tempor eros eget, porttitor nisl.
          </Typography>
        </FuseAnimate>
      </div>
      ...
      <FuseAnimate animation={{ translateX: [0, "100%"] }}>
        <Card className="w-full max-w-400 mx-auto m-16 md:m-0" square>
          <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">
            ...
            <Typography
              variant="h6"
              className="text-center uppercase md:w-full mb-48"
            >
              Connectez-vous
            </Typography>

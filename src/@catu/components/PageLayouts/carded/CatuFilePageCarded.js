...
const CatuFilePageCarded = React.forwardRef(function (props, ref) {
      ...
      <div className="flex w-full">
        ...
        >
          ...
          <div className={clsx(props.innerScroll && "inner-scroll")}>
            {props.headerCardContent && (
              <div className={clsx(classes.firstContentCard, "mb-20 p-16")}>
                {props.headerCardContent}
              </div>
            )}
...
CatuFilePageCarded.defaultProps = {};

export default React.memo(CatuFilePageCarded);
